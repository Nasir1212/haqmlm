			...
			<div class="col-12">
				<div class="card h-100">
					<div class="table-responsive">
                        <h4>Non Working Matrix Condition List &nbsp; <button type="button" class="btn btn-info addNew" data-toggle="modal" data-target="#condition_creating_form">Add new</button></h4>
                        <table class="table custom-table table-bordered table-striped m-0">
                            ...
                            <tbody>
                                @foreach ( $NonWorkingMatrixCondition as $key => $data)
                                <tr>
                                    <td>{{ $key + 1  }}</td>
                                    ...
                                    <td>
                                       ...
                                       <form action="{{ route('non_working_matrix_condition_remove') }}" method="post" class="d-inline-block">
                                    @csrf
        ...
        <div class="modal fade" id="condition_creating_form" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-modal="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('non_working_matrix_condition_store')}}" method="post">
                        @csrf
        ...
        <div class="modal fade" id="condition_update_form" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-modal="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('non_working_matrix_condition_update')}}" method="post">
                        @csrf
                    <div class="modal-body">
