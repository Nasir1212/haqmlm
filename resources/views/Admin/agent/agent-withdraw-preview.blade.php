                ...
                <div class="card card-withdraw text-center">
                    <div class="card-body card-body-withdraw">
                        <ul class="list-group text-center">
                            ...
                            <p class="list-group-item">
                                You will get: <strong> {{ $_GET['payable_amount']}}</strong> {{ $_GET['supported_currencies']}}
                            </p>
                            <p class="list-group-item">
...
<div class="modal fade" id="withdrawModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-modal="true" style="padding-right: 17px;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form action="{{ route('agent_withdraw_submit')}}" method="post" enctype="multipart/form-data">
				@csrf
						...
						<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12 text-center">
										<p class="text-center mt-2">You have requested  <b class="text--success">{{ $_GET['request_amount']}} USD</b>, You will get  <b class="text--success"> {{ $_GET['payable_amount']}} {{ $_GET['supported_currencies']}}</b> for this withdraw  </p>
