...
@section('content')
	<div class="main-container">
		...
		<div class="page-header">
			...
			<!-- Breadcrumb start -->
			<ol class="breadcrumb">
				<li class="breadcrumb-item">Admin Dashboard Balance Add</li>
			</ol>
			<!-- Breadcrumb end -->
		</div>
		<!-- Page header end -->
			<div class="row gutters">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					...
					<div class="card">
						<div class="card-body">
							<form action="{{ route('balance_add_action')}}" method="post" enctype="multipart/form-data">
								@csrf
                                ...
                                @endphp
									<div class="form-group">
										<label for="balance_type" class="w-100 font-weight-bold mb-1">Transfer Type<span class="text-danger">*</span></label>
